...
import com.example.tradingapp.databinding.ActivityTopic3Binding
import com.google.firebase.firestore.FirebaseFirestore

class Topic3 : AppCompatActivity() {
    private lateinit var binding: ActivityTopic3Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title = "Topic 3"
        actionBar.setDisplayHomeAsUpEnabled(true)
        binding.recyclerTopic1.apply {
            layoutManager = LinearLayoutManager(this@Topic3)
        }
        fetchtopic1()
    ...
    private fun fetchtopic1() {
        FirebaseFirestore.getInstance().collection("Topic 3")
            .get()
